<?php
    ...
    function guardarDatos($conn, $datos) {
        ...
        $antiguedad_menos_1_mujeres_propias = $_POST['antiguedad_menos_1_mujeres_propias'] ?? 0;
        $antiguedad_menos_1_mujeres_contratistas = $_POST['antiguedad_menos_1_mujeres_contratistas'] ?? 0;
        $antiguedad_menos_1_hombres_propios = $_POST['antiguedad_menos_1_hombres_propios'] ?? 0;
        $antiguedad_menos_1_hombres_contratistas = $_POST['antiguedad_menos_1_hombres_contratistas'] ?? 0;
    ...
    if ($stmt->execute()) {
        echo "<script type='text/javascript'>
                ...
                window.location = 'encuesta_Categorizacion_Genero.html';
              </script>";
    } else {
        echo "<script type='text/javascript'>
